...
class AnemoiProfiler(AnemoiTrainer):
    ...
    def print_metadata() -> None:
        console.print(f"[bold blue] SLURM NODE(s) {os.getenv('HOST', default='???')} [/bold blue]!")
        console.print(f"[bold blue] SLURM JOB ID {os.getenv('SLURM_JOB_ID', default='???')} [/bold blue]!")
